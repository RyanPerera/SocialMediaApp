            ...
            try{
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e==null){
                            FancyToast.makeText(HomeActivity.this, "Image successfully uploaded!", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false).show();

                        } else{
                            FancyToast.makeText(HomeActivity.this, "Image failed to upload", FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
